const productDetails = {
    "karuppu-kavuni": {
      ...
      allergyInfo: "Contains nuts. May contain traces of sesame and dairy.",
    ...
    "karuppukavunimix":   {
        ...
        category: "Poridge Mix",
        price: "₹170",
        weight: "250g",
        expiry: "Best before 6 months",
        description: "Karuppu Kavuni Porridge Mix is a treasure trove of antioxidants and iron, made from the ancient royal rice variety. It is excellent for improving blood flow, strengthening the heart, and boosting stamina. Enjoy a nourishing bowl every morning as a filling, energizing, and gluten-free breakfast.",
        tags: ["IRON RICH", "HEART HEALTH", "GLUTEN FREE"],
        benefits: ["Boosts Energy", "Supports Heart Health", "Improves Circulation"],
        allergyInfo: "May contain traces of nuts or dairy.",
        imageFolder: "./Images/poridge/Karuppu Kavuni/"
      },


      "mapillaisambamix":{
        name: "Maappillai Samba Porridge Mix",
        category: "Poridge Mix",
        price: "₹90",
        weight: "250g",
        expiry: "Best before 6 months",
        description: "Made from the famed red rice 'Maappillai Samba', this porridge mix is ideal for building stamina and bone strength. Traditionally consumed for its ability to support active lifestyles, it’s a natural source of iron and fiber. Shivaayaas brings this classic grain to your breakfast bowl with all its heritage and health benefits.",
        tags: ["FIBER RICH", "STAMINA BOOST", "TRADITIONAL GRAIN"],
        benefits: ["Improves Bone Strength", "Supports Gut Health", "Enhances Endurance"],
        allergyInfo: "May contain traces of nuts or sesame.",
        imageFolder: "./Images/poridge/Mapillai Samba/"
      },

      "karuppuulundhumix":    {
        name: "Karuppu Ulunthu Porridge Mix",
        category: "Poridge Mix",
        price: "₹110",
        weight: "250g",
        expiry: "Best before 6 months",
        description: "Karuppu Ulunthu (Black Urad Dal) is known for strengthening bones and supporting women’s health. This porridge mix is crafted using hand-roasted urad dal blended with millets, delivering a nourishing and satisfying meal. Perfect for postpartum recovery, bone support, and overall vitality.",
        tags: ["WOMEN FRIENDLY", "BONE HEALTH", "PROTEIN RICH"],
        benefits: ["Strengthens Bones", "Aids Postpartum Recovery", "Improves Hormonal Balance"],
        allergyInfo: "Contains urad dal. May contain traces of ghee or nuts.",
        imageFolder: "./Images/poridge/Karuppu Ulunthu/"
      }      
  };
